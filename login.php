...
// If user clicks the home button, redirect to index.php
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($email)) {
        ...
        if ($emailValidation !== true && !empty($emailValidation)) {
    ...
    if (!empty($password)) {
        ...
        if ($passwordValidation !== true && !empty($passwordValidation)) {
    ...
    if (!empty($errors)) {
        ...
        if (isset($_SESSION['gotofriendadd']) && $_SESSION['gotofriendadd']) {
            header("location:friendadd.php");
            exit;
        } else if (isset($_SESSION['gotofriendlist']) && $_SESSION['gotofriendlist']) {
    ...
    <main>
        ...
        <form action="login.php" method="post">
            <table id="login-table">
                <tr>
                    <td>Email:</td>
                    <td><input type="text" name="email" value="<?php echo isset($_SESSION['user_email']) ? $_SESSION['user_email'] : ''; ?>"></td>
                </tr>
                <tr>
                    <td>Password:</td>
